...
template <typename T> struct tc_skip_list_iterator
{
    typedef tc_skip_list_iterator<T>                self_type;
    ...
    tc_skip_list_iterator() : m_pNode() {  };
    
    tc_skip_list_iterator(node_type* pNode) : m_pNode(pNode) {  };
...
template <typename T> struct tc_skip_list_const_iterator
{
    typedef tc_skip_list_const_iterator<T>          self_type;
    typedef skip_list_node_s<T>                     node_type;
    typedef tc_skip_list_iterator<T>                iterator;
    ...
    tc_skip_list_const_iterator() : m_pNode() {  };
    
    tc_skip_list_const_iterator(const node_type* pNode) : m_pNode(pNode) {  };
    
    tc_skip_list_const_iterator(const iterator& stIter) : m_pNode(stIter.m_pNode) {  };
...
public:
    ...
    typedef skip_list_node_s<T>                     node_type;
    typedef tc_skip_list_iterator<T>                iterator;
    typedef tc_skip_list_const_iterator<T>          const_iterator;
...
public:
    CTCSkipList()
    {
        ...
        m_stCmp = [](const T& a, const T& b) { return std::greater<ScoreT>()(a.second, b.second); };
    ...
    void SetCmp(bool bIsLess)
    {
        if(bIsLess)
            m_stCmp = [](const T& a, const T& b) { return std::less<ScoreT>()(a.second, b.second); };
        else
            m_stCmp = [](const T& a, const T& b) { return std::greater<ScoreT>()(a.second, b.second); };
    }
