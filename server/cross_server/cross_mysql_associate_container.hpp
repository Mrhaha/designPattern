...
class CCrossSQLRecordAssociateContainer {  };

template <typename KeyT, typename TableT, typename TableValT>
class CCrossSQLRecordAssociateContainer<KeyT, TableT*, TableValT>
{
public:
...
public:
    CCrossSQLRecordAssociateContainer() : m_stRecordMap() {}
    
    ~CCrossSQLRecordAssociateContainer()
    {
	...
	CCrossSQLRecordAssociateContainer(const CCrossSQLRecordAssociateContainer&) = delete;
	CCrossSQLRecordAssociateContainer& operator=(const CCrossSQLRecordAssociateContainer&) = delete;
