...
#include "cross_record_rank_skiplist.h"
...
class CCrossSQLRankAssociateContainer {  };

template <typename KeyT, typename TableT, typename TableValT>
class CCrossSQLRankAssociateContainer<KeyT, TableT*, TableValT>
{
public:
    typedef KeyT key_type;
    typedef CLogicRankSkipList<key_type> rank_container_type;
    typedef CCrossSQLRecordAssociateContainer<key_type, TableT*, TableValT> record_container_type;
    ...
    CCrossSQLRankAssociateContainer() : m_stRankContainer(), m_stRecordContainer() {}

    explicit CCrossSQLRankAssociateContainer(unsigned int uiMaxRank) : m_stRankContainer(uiMaxRank), m_stRecordContainer() {}

    ~CCrossSQLRankAssociateContainer() = default;

    CCrossSQLRankAssociateContainer(const CCrossSQLRankAssociateContainer&) = delete;
    CCrossSQLRankAssociateContainer& operator=(const CCrossSQLRankAssociateContainer&) = delete;
