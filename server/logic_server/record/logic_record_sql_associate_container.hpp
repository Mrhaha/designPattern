...
class CLogicSQLRecordAssociateContainer {  };

template <typename KeyT, typename TableT, typename TableValT>
class CLogicSQLRecordAssociateContainer<KeyT, TableT*, TableValT>
{
public:
...
public:
    CLogicSQLRecordAssociateContainer() : m_stRecordMap() {}
    
    ~CLogicSQLRecordAssociateContainer()
    {
	...
	CLogicSQLRecordAssociateContainer(const CLogicSQLRecordAssociateContainer&) = delete;
	CLogicSQLRecordAssociateContainer& operator=(const CLogicSQLRecordAssociateContainer&) = delete;
...
private:
    map_container_type         m_stRecordMap;
};
